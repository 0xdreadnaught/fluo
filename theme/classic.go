...
func Light() *Theme {
	return &Theme{
		...
		Color: ColorTokens{
			...
			FocusStroke:           render.RGB(0, 0, 128),
			ScrollThumb:           render.RGB(128, 128, 128),
			...
			CloseButtonHover:      render.RGBA(232, 17, 35, 255),
...
func Dark() *Theme {
	return &Theme{
		...
		Color: ColorTokens{
			...
			FocusStroke:           render.RGB(42, 77, 143),
			ScrollThumb:           render.RGB(32, 32, 32),
